...
export const url = `${baseAPIUrl}/api/pubmedSummary/pubmed_summary`
...
export const defaultPrompt = `${termsSection}
${abstractsAccess}
${tastSection}
${examplesSection}
${abstractsSection}
...
export const createToggleIncludeAbstracts = ({ set, get }) => (include) => {
